...
def main():
    ...
    #reduduce dimensions with ICA
    X_train = to_dense(X_train)
    X_train, model_ica = Optimise.apply_ica(X_train, 45)
    scale_time = time.time() - start_scale
    print (f"Scaling to 45 using ICA {training_file}:  {scale_time:.5f} seconds")
